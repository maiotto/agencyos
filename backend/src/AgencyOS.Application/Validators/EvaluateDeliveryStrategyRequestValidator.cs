...
public class EvaluateDeliveryStrategyRequestValidator : AbstractValidator<EvaluateDeliveryStrategyRequest>
{
    public EvaluateDeliveryStrategyRequestValidator()
    {
