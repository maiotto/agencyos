...
public class PersonalProductivityDashboardQueryParametersValidator
    : AbstractValidator<PersonalProductivityDashboardQueryParameters>
{
    public PersonalProductivityDashboardQueryParametersValidator()
    {
