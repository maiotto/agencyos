...
public class DeliveryStrategyQueryParametersValidator : AbstractValidator<DeliveryStrategyQueryParameters>
{
    public DeliveryStrategyQueryParametersValidator()
    {
