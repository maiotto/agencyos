...
public class ExecutiveWorkspaceQueryParametersValidator : AbstractValidator<ExecutiveWorkspaceQueryParameters>
{
    public ExecutiveWorkspaceQueryParametersValidator()
    {
