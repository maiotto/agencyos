...
public class DeliveryStrategyExplanationQueryParametersValidator
    : AbstractValidator<DeliveryStrategyExplanationQueryParameters>
{
    public DeliveryStrategyExplanationQueryParametersValidator()
    {
