...
public class EnterpriseDashboardQueryParametersValidator : AbstractValidator<EnterpriseDashboardQueryParameters>
{
    public EnterpriseDashboardQueryParametersValidator()
    {
