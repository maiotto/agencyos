...
public class AllocationConflictQueryParametersValidator : AbstractValidator<AllocationConflictQueryParameters>
{
    public AllocationConflictQueryParametersValidator()
    {
